...
var Return = function(expression) {
  this.kind = 'Return';
...
var Assign = function(assignable, expression) {
  this.kind = 'Assign';
 ...
 */
var Property = function(expression, identifier) {
  this.kind = 'Property';
  this.expression = expression;
  this.identifier = identifier;
 ...
 */
var ListAccessor = function(expression, index_expression) {
...
var Param = function(type, identifier) {
  this.type = type;
  this.identifier = identifier;
...
var Call = function(identifier, receiver, args) {
  this.kind = 'Call';
  this.identifier = identifier;
...
var Create = function(constant, args) {
  this.kind = 'Create';
  this.constant = constant;
  this.args = args;
...
var Argument = function(identifier, argument) {
  this.kind = 'Argument';
  this.identifier = identifier;
...
var Operator = function(operator, left, right) {
...
var If = function(conditional, true_branch, false_branch) {
...
var While = function(conditional, block) {
  this.conditional = conditional;
  this.block = block;
