...
Node.prototype.evaluate = function(context) {
  try {
    ...
    if (error.is_wardrobe_error && !error.hasLineNo()) {
      error.setLineNo(this.line_no, text);
    }
    throw error;
  }
  return context;
...
break;
case 6:this.$ = new yy.Block($$[$0-1], yylineno, yytext);
break;
case 7:this.$ = $$[$0];
break;
case 8:this.$ = $$[$0];
break;
case 9:this.$ = new yy.Comment($$[$0], yylineno, yytext);
break;
case 10:this.$ = new yy.Return($$[$0], yylineno, yytext);
break;
case 11:this.$ = $$[$0];
break;
case 12:this.$ = new yy.Declare($$[$0-1], $$[$0], yylineno, yytext);
break;
case 13:this.$ = $$[$0];
break;
case 14:this.$ = $$[$0];
...
case 28:this.$ = $$[$0];
break;
case 29:this.$ = new yy.Assign($$[$0-2], $$[$0], yylineno, yytext);
break;
case 30:this.$ = new yy.Assign($$[$0-2], $$[$0], yylineno, yytext);
break;
case 31:this.$ = $$[$0];
break;
case 32:this.$ = $$[$0];
break;
case 33:this.$ = new yy.Identifier($$[$0], yylineno, yytext);
break;
case 34:this.$ = new yy.Property($$[$0-2], $$[$0], yylineno, yytext);
break;
case 35:this.$ = new yy.ListAccessor($$[$0-3], $$[$0-1], yylineno, yytext);
break;
case 36:this.$ = new yy.Constant($$[$0], yylineno, yytext);
break;
case 37:this.$ = new yy.Number($$[$0], yylineno, yytext);
break;
case 38:this.$ = new yy.String($$[$0], yylineno, yytext);
break;
case 39:this.$ = new yy.True(yylineno, yytext);
break;
case 40:this.$ = new yy.False(yylineno, yytext);
break;
case 41:this.$ = $$[$0];
break;
...
break;
case 46:this.$ = new yy.This(yylineno, yytext);
break;
case 47:this.$ = new yy.Class($$[$0-2], null, $$[$0-1], yylineno, yytext);
break;
case 48:this.$ = new yy.Class($$[$0-4], $$[$0-2], $$[$0-1], yylineno, yytext);
break;
case 49:this.$ = new yy.Function(null, $$[$0-5], $$[$0-3], $$[$0-1], yylineno, yytext);
break;
case 50:this.$ = new yy.Function($$[$0-6], $$[$0-5], $$[$0-3], $$[$0-1], yylineno, yytext);
break;
case 51:this.$ = [];
break;
case 52:this.$ = [new yy.Param($$[$0-1], $$[$0])];
break;
case 53:this.$ = $$[$0-3]; $$[$0-3].push(new yy.Param($$[$0-1], $$[$0], yylineno, yytext));
break;
case 54:this.$ = new yy.Call($$[$0-3], $$[$0-5], $$[$0-1], yylineno, yytext);
break;
case 55:this.$ = new yy.Call($$[$0-3], null, $$[$0-1], yylineno, yytext);
break;
case 56:this.$ = new yy.Create($$[$0-3], $$[$0-1], yylineno, yytext);
break;
case 57:this.$ = $$[$0];
break;
case 58:this.$ = $$[$0];
...
break;
case 62:this.$ = $$[$0-4]; $$[$0-4].push(new yy.Argument($$[$0-2], $$[$0], yylineno, yytext));
break;
case 63:this.$ = new yy.Operator($$[$0-1], null, $$[$0], yylineno, yytext);
break;
case 64:this.$ = new yy.Operator($$[$0-1], null, $$[$0], yylineno, yytext);
break;
case 65:this.$ = new yy.Operator($$[$0-1], $$[$0-2], $$[$0], yylineno, yytext);
break;
case 66:this.$ = new yy.Operator($$[$0-1], $$[$0-2], $$[$0], yylineno, yytext);
break;
case 67:this.$ = new yy.Operator($$[$0-1], $$[$0-2], $$[$0], yylineno, yytext);
break;
case 68:this.$ = new yy.Operator($$[$0-1], $$[$0-2], $$[$0], yylineno, yytext);
break;
case 69:this.$ = new yy.Operator($$[$0-1], $$[$0-2], $$[$0], yylineno, yytext);
break;
case 70:this.$ = new yy.If($$[$0-2], $$[$0-1], null, yylineno, yytext);
break;
case 71:this.$ = new yy.If($$[$0-4], $$[$0-3], $$[$0-1], yylineno, yytext);
break;
case 72:this.$ = new yy.If($$[$0-3], $$[$0-2], $$[$0], yylineno, yytext);
break;
case 73:this.$ = new yy.While($$[$0-3], $$[$0-1], yylineno, yytext);
break;
case 74:
break;
case 75:this.$ = new yy.For($$[$0-5], $$[$0-3], $$[$0-1], yylineno, yytext);
break;
}
},
